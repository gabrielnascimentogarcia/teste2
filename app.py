...
class MIC1SimulatorApp:
    def __init__(self, root):
        self.root = root
        # Título com os nomes da galera do grupo
        self.root.title("Simulador MIC-1 Gabriel G. Iuri F. Maria Eduarda V. Marilia S. Pedro L. Yasmin M.")
        self.root.geometry("1400x800")
        self.root.configure(bg="#2b2b2b") # Dark mode pra não cansar a vista
        
        # Configuração de estilos do Tkinter (apanhamos um pouco aqui pra tirar o cinza padrão)
        ...
        # Preenche a tabela de memória logo no início
        self.init_memory_view()
        self.update_ui()

    # Função auxiliar pra converter unsigned 16-bit para signed (pra ficar legível na UI)
    ...
    def create_widgets(self):
        ...
        # --- COLUNA DA ESQUERDA (Editor e Controles) ---
        ...
        # Exemplo padrão já carregado pra facilitar o teste
        ...
        # --- COLUNA DA DIREITA (Registradores, Caches, Memória) ---
        ...
        # Gerando os cards dos registradores dinamicamente
        r, c = 0, 0
        for reg in regs:
        ...
        # Sistema de Abas para as Caches (Dados vs Instrução)
        ...
        # Configuração da Tabela de Cache de Dados
        ...
        # Configuração da Tabela de Cache de Instruções
    ...
    def update_full_memory_view(self):
        ...
        # CUIDADO: Isso pode ser pesado se atualizar muito rápido.
        for addr in range(4096):
    ...
    def update_ui(self):
        ...
        # Logs do sistema (Cache hit/miss e microinstruções)
