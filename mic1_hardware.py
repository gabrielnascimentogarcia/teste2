...
class MIC1Hardware:
    ...
    def step(self):
        ...
        # Separa Opcode e Operando (Usando máscaras binárias)
        ...
        if opcode_4 == 0b0000: # LODD - Carrega direto do endereço
        ...
        elif opcode_4 == 0b0111: # LOCO - Carrega constante (0-4095)
        ...
        elif opcode_4 == 0b1110: # CALL - Procedimentos
            ...
            elif instruction == 0b1111000000000000: # PSHI (Indireto)
            ...
            elif instruction == 0b1111001000000000: # POPI (Indireto)
